...
{
	/// <summary>
	/// Reviews Collection View Component (ASP.NET Core 1.1)
	/// </summary>
	public class ReviewsViewComponent : ViewComponent
	{
		...
		public ReviewsViewComponent(AdministrationContext context)
		{
			_context = context;
		}

		/// <summary>
		/// Reviews View Component (lists)
		/// </summary>
		...
		/// <param name="reviewsPage">Page number of results, starting at 0</param>
			...
			string currentFilter = "")
		{
			...
			if (string.IsNullOrEmpty(reviewsPage)) reviewsPage = "1";
			int page = 1;
			int.TryParse(reviewsPage, out page);
			...
			ViewData["reviewsPage"] = page.ToString();
			...
			return View(await PaginatedList<Review>.CreateAsync(results.AsNoTracking(), page, pageSize ?? 4));
		}

	} // End of Class ReviewsViewComponent
