...
{
	/// <summary>
	/// TestField Item View Component (ASP.NET Core 1.1)
	/// </summary>
	public class TestFieldViewComponent : ViewComponent
	{
		...
		public TestFieldViewComponent(AdministrationContext context)
		{
			_context = context;
		}
			...
			string currentFilter)
		{
			...
			if (returnField == null) returnField = "testFieldId";
			...
			if (item == null) item = new TestField();
			return View(viewType,item);
		}

	} // End of Class TestFieldViewComponent
