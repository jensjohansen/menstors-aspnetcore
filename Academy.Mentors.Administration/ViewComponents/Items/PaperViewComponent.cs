...
{
	/// <summary>
	/// Paper Item View Component (ASP.NET Core 1.1)
	/// </summary>
	public class PaperViewComponent : ViewComponent
	{
		...
		public PaperViewComponent(AdministrationContext context)
		{
			_context = context;
		}
			...
			string currentFilter)
		{
			...
			if (returnField == null) returnField = "paperId";
			...
			if (item == null) item = new Paper();
			return View(viewType,item);
		}

	} // End of Class PaperViewComponent
