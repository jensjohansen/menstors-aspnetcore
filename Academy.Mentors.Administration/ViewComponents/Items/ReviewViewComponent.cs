...
{
	/// <summary>
	/// Review Item View Component (ASP.NET Core 1.1)
	/// </summary>
	public class ReviewViewComponent : ViewComponent
	{
		...
		public ReviewViewComponent(AdministrationContext context)
		{
			_context = context;
		}
			...
			string currentFilter)
		{
			...
			if (returnField == null) returnField = "reviewId";
			...
			if (item == null) item = new Review();
			return View(viewType,item);
		}

	} // End of Class ReviewViewComponent
