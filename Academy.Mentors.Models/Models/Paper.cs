...
namespace Academy.Mentors.Models
{
	...
	/// </summary>
	[DataContract]
	public partial class Paper : IEquatable<Paper>
	{
		/// <summary>
		...
		/// <summary>
		/// Data Member Papers.Name (varchar)
		/// </summary>
		...
		/// <summary>
		/// Data Member Papers.Description (varchar)
		/// </summary>
		...
		/// <summary>
		/// Data Member Papers.ContributorId (bigint)
		/// </summary>
		...
		/// <summary>
		/// Data Member Papers.Comments (text)
		/// </summary>
		...
		/// <summary>
		/// Data Member Papers.AuditEntered (datetime)
		/// </summary>
		...
		/// <summary>
		/// Data Member Papers.AuditEnteredBy (bigint)
		/// </summary>
		...
		/// <summary>
		/// Data Member Papers.AuditUpdated (datetime)
		/// </summary>
		...
		/// <summary>
		/// Data Member Papers.AuditUpdatedBy (bigint)
		/// </summary>
		...
		/// <summary>
		/// Full Constructor for Paper Object
		/// </summary>
		...
		/// <summary>
		/// Returns true if Paper objects are Equal
		/// </summary>
