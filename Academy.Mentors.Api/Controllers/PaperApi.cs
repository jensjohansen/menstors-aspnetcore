...
{
    /// <summary>
    /// Papers RESTful API Controller (ASP.NET Core)
    /// </summary>
    [ApiExplorerSettings(IgnoreApi = false)]
    public class PaperApiController : PaperBaseApiController
    {
        /// <summary>
        /// Paper API Controller
        /// </summary>
        /// <param name="apiDataContext">DbContext for EntityFramework</param>
        /// <param name="logger">Injected ILoggerFactory</param>
        public PaperApiController(ApiDataContext apiDataContext, ILoggerFactory logger) : base(apiDataContext, logger)
        { 
        }
